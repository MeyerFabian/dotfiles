...
values."
  (setq-default
   ...
   '(
     ...
     ;; syntax-checking
     ;; version-control
     (auto-completion :variables auto-completion-complete-with-key-sequence-delay 0.0)
     shell
     )
